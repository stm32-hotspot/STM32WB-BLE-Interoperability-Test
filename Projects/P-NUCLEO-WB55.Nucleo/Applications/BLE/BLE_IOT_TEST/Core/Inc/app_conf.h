 ...
 */
#define CFG_GAP_DEVICE_NAME             "IOT_test"
...
typedef enum
{
  ...
  /* USER CODE BEGIN CFG_Task_Id_With_NO_HCI_Cmd_t */
	...
	CFG_TASK_SEND_DATA_NOTIFICATION_ID,
	CFG_TASK_SEND_DATA_INDICATION_ID,
	CFG_TASK_SLAVE_SECURITY_REQ_ID,
	CFG_TASK_CLEAR_SECURITY_DB_ID,
